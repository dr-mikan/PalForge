...
| `gallery/` | **three cards for the Nexus page**, framed around what a pack can ADD. Generated by `tools/gen-cards.py`; `gallery/README.md` carries the design language and why there are three of them. |
