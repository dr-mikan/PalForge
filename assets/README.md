...
| `gallery/` | **three cards for the Nexus page**, framed around what a pack can ADD. Three and not nine on purpose — see `cards/README.md`. |
| `cards/` | **nine 1280×720 capability cards** — one per thing a pack can extend. The Nexus gallery, and the docs hero images. GENERATED by `tools/gen-cards.py`; see `cards/README.md` for the design language they share. |
